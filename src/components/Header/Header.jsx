...
import { ButtonUnivers } from "./Button";
...
export const Header = React.memo(() => {
  ...
  const { totalPrice, totalCount } = useSelector((state) => ({
	  //todo указать конкретные свойства что бы избежать лишнего ререндера
    ...
    <div className="header">
      <div className="container">
        ...
        <div className="header__cart">
          <Link to={"/cart"}>
            <ButtonUnivers className="button--cart" onClick={onClickButtonCart}>
